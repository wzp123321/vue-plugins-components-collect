...
@Component({
  selector: 'ems-freezer-multiple-analysis',
  templateUrl: './freezer-multiple-analysis.component.html',
  styleUrls: ['./freezer-multiple-analysis.component.less'],
  providers: [FreezerMultipleAnalysisService, NumberSeparatorPipe],
  viewProviders: [{ provide: PaginationService, useExisting: FreezerMultipleAnalysisService }],
})
export class FreezerMultipleAnalysisComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    @Self() private service: FreezerMultipleAnalysisService,
