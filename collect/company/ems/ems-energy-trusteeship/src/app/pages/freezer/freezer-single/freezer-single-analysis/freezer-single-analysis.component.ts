...
import { CHART_COLOR_OPTIONS, FMixinAlpha, LINE_CHART_COLOR_LIST } from 'src/app/core/color/color.api';
import { F_IAnalysisSeriesItem } from '../../freezer.api';
...
@Component({
  selector: 'ems-freezer-single-analysis',
  templateUrl: './freezer-single-analysis.component.html',
  styleUrls: ['./freezer-single-analysis.component.less'],
  providers: [FreezerSingleAnalysisService, NumberSeparatorPipe],
  viewProviders: [{ provide: PaginationService, useExisting: FreezerSingleAnalysisService }],
})
export class FreezerSingleAnalysisComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    @Self() private service: FreezerSingleAnalysisService,
  ...
  public mapTableTitle(item: F_IAnalysisSeriesItem): string {
