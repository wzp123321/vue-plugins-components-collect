...
@Injectable()
export class BoilerMultipleAnalysisService extends PaginationService implements OnDestroy {
  ...
  constructor(private sCommunication: BoilerCommunicationService, private sDatabase: BoilerDatabaseService) {
    super();
