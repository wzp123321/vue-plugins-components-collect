...
export default class GatewayUtil {
  ...
  static decryptSecret() {
    ...
    const accessToken = FGetSessionStorageData('energy-ems-access-secret') as string;
    console.log('accessToken--------------', accessToken);
    return AesGcmNoPaddingUtil.decrypt(accessToken, Base64Util.encode(key));
  }
  ...
  static buildClientAccessToken() {
    ...
    if (item) {
      try {
        ...
        console.warn('------------', shareText, decryptShareRes);
