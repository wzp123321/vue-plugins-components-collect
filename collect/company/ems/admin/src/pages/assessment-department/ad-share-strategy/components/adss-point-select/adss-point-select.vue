<template>
  <div class="adss-point-select">
    <!-- 站点 -->
    <div class="aps-point-select-item">
...
import { PointService } from './adss-point-select-service';
import { Adssa_PointItem, SelectedPoint } from './adss-point-select-api';
