...
const EnergyConservationServation = {
   ...
   * @param params
   */
  async getEnergyType(params?: number): Promise<HttpRequestModule.ResTemplate<any>> {
  ...
  async getList(
    ...
    const res: HttpRequestModule.ResTemplate<energyConservation.returnListTYPE> = await postRequest(reqUrl, params);
    return res;
  },
  /**
   * 新增
   * @param params
   */
  async addUrl(params: energyConservation.addUrlType): Promise<HttpRequestModule.ResTemplate<null>> {
    const reqUrl = '/saveenergyquota/add';
    const res: HttpRequestModule.ResTemplate<null> = await postRequest(reqUrl, params);
    return res;
  },
  /**
   * 修改
   * @param params
   */
  async getTreeBindRefresh(params: energyConservation.upadateUrlType): Promise<HttpRequestModule.ResTemplate<null>> {
   ...
   * @param params
   */
  async getTreeUnBind(params: number): Promise<HttpRequestModule.ResTemplate<null>> {
