<template>
  <div class="energy-item-ratio">
    <div class="eir-switch--wrap">
      <switch-button
    ...
    <div class="eir-back-button" v-if="areaId || areaId === 0">
      <el-button @click="backClick" type="primary">返回上级</el-button>
    </div>
    <div class="eir-chart">
      <energy-item-ratio-chart
        :nodeName="nodeName"
...
import EnergyItemRatioChart from './components/home-er-chart.vue';
...
.energy-item-ratio {
  color: var(--iot-font-color-shadow);
  position: relative;
  .eir-switch--wrap {
    position: absolute;
    top: 16px;
