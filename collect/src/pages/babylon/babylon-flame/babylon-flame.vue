  ...
  <div class="babylon-flame">
    ...
    <div class="control-panel">
      ...
      <div class="control-item">
        <label>
          火焰发射率:
          <span>{{ formatNum(flameEmitRate) }}/s</span>
        </label>
      ...
      <div class="control-item">
        <label>
          火焰速度:
          <span>{{ flameSpeed.toFixed(2) }}</span>
        </label>
      ...
      <div class="control-item">
        <label>
          烟雾发射率:
          <span>{{ formatNum(smokeEmitRate) }}/s</span>
        </label>
      ...
      <div class="control-item">
        <label>
          火花发射率:
          <span>{{ formatNum(sparkEmitRate) }}/s</span>
        </label>
...
function createScene() {
  ...
  for (let i = 0; i < 5; i++) {
    ...
    const log = BABYLON.MeshBuilder.CreateCylinder(`log_${i}`, { height: 1.5, diameter: 0.15 }, scene);
